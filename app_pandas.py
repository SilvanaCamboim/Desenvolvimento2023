...
def main():
  polygons = gpd.read_file('https://github.com/SilvanaCamboim/Desenvolvimento2023/blob/main/bairros.geojson')
  points = gpd.read_file('https://github.com/SilvanaCamboim/Desenvolvimento2023/blob/main/estacionamentos.geojson')
